...
def _serialize_final_state(final_state: dict):
    if final_state is None:
        return None

    completed_at = final_state.get('final_completed_at')
...
def upsert_content_override():
    ...
    if not result.get('success'):
        ...
        return _error_response(500, 'UNKNOWN_ERROR', 'Failed to upsert override')
